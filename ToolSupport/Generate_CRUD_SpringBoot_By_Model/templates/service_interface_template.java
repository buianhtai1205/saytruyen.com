...
public interface {{ entity_name }}Service {
    ...
    void create{{ entity_name }}({{ entity_name }}Request {{ entity_name | lower }}Request);

    void update{{ entity_name }}({{ entity_name }}Request {{ entity_name | lower }}Request, {{ id_type}} {{ entity_name | lower }}Id);
