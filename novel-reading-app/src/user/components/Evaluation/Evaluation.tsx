            ...
            <div className={clsx(styles.evaluationList)}>
                {evaluations.map((evaluation, index) => {
                    ...
                    return (
                        <div
                            key={evaluation.id}
                            className={clsx(styles.evaluationItem)}
                        >
                            <div
                                className={clsx(
                                    styles.evaluationTitleContainer
                                )}
                            >
                                <div className={clsx(styles.evaluationTitle)}>
                                    ...
                                    <span
                                        className={clsx(
                                            styles.evaluationTitleSeparator
                                        )}
                                    >
                                        {' '}
                                        đã đánh giá{' '}
                                ...
                                <span className={clsx(styles.rating)}>
                                    ⭐ {evaluation.rating}
                                </span>
                            </div>
                            <p
