...
import vn.com.saytruyen.common_service.service.FileService;
import vn.com.saytruyen.common_service.utils.FileUtils;
    ...
    public List<FileResponse> uploadFileToAWSS3(MultipartFile[] files, String folderName) {
        ...
        for (MultipartFile file : files) {
            ...
            fileResponses.add(FileResponse.builder()
                    .fileName(fileName)
                    .fileUrl(s3Client.getUrl(bucketName, folderName + fileName).toString())
